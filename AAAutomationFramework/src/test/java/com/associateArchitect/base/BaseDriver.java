package com.associateArchitect.base;
...
public class BaseDriver implements IRetryAnalyzer,IAnnotationTransformer,ITestListener  {
	        ...
	        case "FAIL":
	            ...
	            if (driver != null) {
	                ...
	                if (screenshot != null) {
	                		...
	                		test.fail("Failure Screenshot",MediaEntityBuilder.createScreenCaptureFromPath(screenshot).build());
